  ...
  return (
    <div className="flex flex-col gap-4 w-[50%]">
      <Typography.body>
        ...
        perspiciatis fugit eum. Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime dolorem ad numquam possimus quasi culpa sit
        non libero quo maiores eius qui, cumque harum fugit dolor labore voluptas repellat velit.
      </Typography.body>
      <Typography.body>
