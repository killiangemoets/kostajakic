...
const DownloadButtons = () => {
  return (
    <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 w-fit items-center gap-2">
      <Button className="normal-case w-[104px] h-8 px-0 text-md font-bold" variant="outline" size="sm">
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 w-full sm:w-[50%] sm:min-w-[500px]">
        <Typography.body className="font-medium">
          <span className="font-bold uppercase">Kosta Jakic</span> lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem
